...
import {SelectDwPertyMemberManageComponent} from './select-dw-perty-member-manage.component';
...
@NgModule({
  ...
  declarations: [SelectDwPertyMemberManageComponent],
  exports: [SelectDwPertyMemberManageComponent],
  providers: [DwPertyMemberManageFieldInfoService, DwPertyMemberManageService]
})
export class SelectDwPertyMemberManageModule {
}
