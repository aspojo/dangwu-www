...
@Injectable()
export class DwPertyMemberManageFieldInfoService extends FieldInfoService {
  ...
  get _fieldInfo(): Array<FieldInfo> {
    return [
      ...
      {
        fieldName: 'generalparty', fieldLabel: '分党委/党总支', showInEdit: 'Y', required: 'Y', component: 'complexSelect',
        relEntityName: 'DwGeneralParty',
      },
      {fieldName: 'generalpartyValue', fieldLabel: '分党委/党总支', showInView: 'Y', displayName: 'generalparty',},
      {
        fieldName: 'branchparty', fieldLabel: '党支部', showInEdit: 'Y', required: 'Y', component: 'complexSelect',
        relEntityName: 'DwGeneralParty',
      },
      ...
      {fieldName: 'ethnicValue', fieldLabel: '民族', showInTable: 'Y', showInView: 'Y', displayName: 'ethnic'},
      ...
      {fieldName: 'age', fieldLabel: '年龄', showInTable: 'Y', showInView: 'Y', required: 'N', showInEdit: 'Y', displayName: 'age'},
      {
        fieldName: 'democrat', fieldLabel: '所属党派', component: 'complexSelect',
        relEntityName: 'DwDemocrat',
      },
      {fieldName: 'democratValue', fieldLabel: '所属党派', displayName: 'democrat'},
      ...
      {fieldName: 'partyPhases', fieldLabel: '党校期数', showInQuery: 'Y', displayName: 'partyPhases'},
      ...
      {fieldName: 'studentcategoryValue', fieldLabel: '类别', showInView: 'Y', displayName: 'studentcategory'},
      {
        fieldName: 'studentlevel', fieldLabel: '层次', showInEdit: 'Y', component: 'select',
      },
      {fieldName: 'studentlevelValue', fieldLabel: '层次', showInView: 'Y', displayName: 'studentlevel'},
      {fieldName: 'studentexistingacademic', fieldLabel: '现有学历', showInEdit: 'Y',},
      {fieldName: 'studentexistingacademicValue', fieldLabel: '现有学历', showInView: 'Y', displayName: 'studentexistingacademic'},
      ...
      {fieldName: 'stafflevel', fieldLabel: '职员级别', showInView: 'Y', showInEdit: 'Y', displayName: 'stafflevel'},
      {
