...
import {SelectDemoOrderComponent} from './select-demo-order.component';
...
@NgModule({
  ...
  declarations: [SelectDemoOrderComponent],
  exports: [SelectDemoOrderComponent],
  providers: [DemoOrderFieldInfoService, DemoOrderService]
})
export class SelectDemoOrderModule {
}
