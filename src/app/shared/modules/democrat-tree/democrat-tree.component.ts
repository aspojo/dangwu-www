...
@Component({
  selector: 'app-democrat-tree',
  templateUrl: './democrat-tree.component.html',
  styleUrls: ['./democrat-tree.component.css'],
})
export class DemocratTreeComponent implements OnChanges {
  @Input() entityName;
  @Input() treeTitle;
  @Input() idField;
  @Input() parentField;
  ...
  loadTreeData() {
    this.http.post('getDemocratTree', {
