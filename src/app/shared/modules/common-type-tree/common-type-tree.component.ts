...
@Component({
  selector: 'app-common-type-tree',
  templateUrl: './common-type-tree.component.html',
  styleUrls: ['./common-type-tree.component.css'],
})
export class CommonTypeTreeComponent implements OnChanges {
  @Input() entityName;
  @Input() treeTitle;
  @Input() idField;
  @Input() parentField;
  ...
  loadTreeData() {
    this.http.post('getCommonTypeTreeData', {
