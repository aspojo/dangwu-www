...
import {SelectDwTitlesComponent} from './select-dw-titles.component';
...
@NgModule({
  ...
  declarations: [SelectDwTitlesComponent],
  exports: [SelectDwTitlesComponent],
  providers: [DwTitlesFieldInfoService, DwTitlesService]
})
export class SelectDwTitlesModule {
}
