...
import {SelectDwFamilyComponent} from './select-dw-family.component';
...
@NgModule({
  ...
  declarations: [SelectDwFamilyComponent],
  exports: [SelectDwFamilyComponent],
  providers: [DwFamilyFieldInfoService, DwFamilyService]
})
export class SelectDwFamilyModule {
}
