...
import {SelectDwGenderComponent} from './select-dw-gender.component';
...
@NgModule({
  ...
  declarations: [SelectDwGenderComponent],
  exports: [SelectDwGenderComponent],
  providers: [DwGenderFieldInfoService, DwGenderService]
})
export class SelectDwGenderModule {
}
