...
import {SelectDwRelationshipComponent} from './select-dw-relationship.component';
...
@NgModule({
  ...
  declarations: [SelectDwRelationshipComponent],
  exports: [SelectDwRelationshipComponent],
  providers: [DwRelationshipFieldInfoService, DwRelationshipService]
})
export class SelectDwRelationshipModule {
}
