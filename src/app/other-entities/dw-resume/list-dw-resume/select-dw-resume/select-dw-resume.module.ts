...
import {SelectDwResumeComponent} from './select-dw-resume.component';
...
@NgModule({
  ...
  declarations: [SelectDwResumeComponent],
  exports: [SelectDwResumeComponent],
  providers: [DwResumeFieldInfoService, DwResumeService]
})
export class SelectDwResumeModule {
}
